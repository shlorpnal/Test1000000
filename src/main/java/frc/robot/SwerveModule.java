...
public class SwerveModule {
  ...
  public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants) {
    ...
    if (moduleNumber == 0 || moduleNumber == 3 || moduleNumber == 2) { 
      mDriveMotor.getConfigurator().apply(Robot.ctreConfigs.swerveDriveAFXConfig);
    } else {
      mDriveMotor.getConfigurator().apply(Robot.ctreConfigs.swerveDriveBFXConfig);
    }
  ...
  //for SysId
  public TalonFX returnDriveMotor() {
    return mDriveMotor;
  }
  ...
  public double getDriveVelocity() {
    return mDriveMotor.getVelocity().getValueAsDouble() * 60;
  }
}
